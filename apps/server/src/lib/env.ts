...
/** 服务端口 */
export const PORT = Number(process.env.PORT ?? 3302)
...
/** OpenClaw 服务地址 */
export const OPENCLAW_URL = process.env.OPENCLAW_URL ?? 'http://localhost:3301'
...
/** CORS 允许的来源 */
export const CORS_ORIGIN = process.env.CORS_ORIGIN ?? 'http://localhost:5302'
