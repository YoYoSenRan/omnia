...
export abstract class BaseService<Row, Insert, CreateInput, UpdateInput> {
  ...
  protected createDetail(_data: CreateInput): Record<string, unknown> {
    return {}
  }
  protected updateDetail(data: UpdateInput): Record<string, unknown> {
    return { fields: Object.keys(data as Record<string, unknown>) }
  }
  protected removeDetail(_existing: Row): Record<string, unknown> {
    return {}
  }
